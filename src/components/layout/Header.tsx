...
import { Sun, Moon, Code2, LayoutDashboard, BookOpen, Dumbbell, Menu, X } from 'lucide-react';
...
export function Header({ sidebarAbierto, onToggleSidebar }: HeaderProps) {
  ...
  const navLinks = [
    { to: '/', label: 'Inicio', icono: <Code2 size={16} /> },
  ...
  return (
    <header className="h-14 flex items-center gap-3 px-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 sticky top-0 z-30">
      ...
      <Link to="/" className="flex items-center gap-2 mr-4">
        ...
        <span className="font-bold text-gray-900 dark:text-white text-sm hidden sm:block">PythonChupas</span>
      </Link>
