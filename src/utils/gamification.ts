import type { ProgresoUsuario, NivelEstudiante, TituloPython } from '../types';
import { INSIGNIAS } from '../content/insignias';
import { unlockInsignia } from './progressStorage';

const NIVELES: Array<{ titulo: TituloPython; xpMin: number; xpMax: number }> = [
  { titulo: 'Explorador', xpMin: 0, xpMax: 199 },
  { titulo: 'Aprendiz Python', xpMin: 200, xpMax: 499 },
  { titulo: 'Pythonista Junior', xpMin: 500, xpMax: 999 },
  { titulo: 'Desarrollador Python', xpMin: 1000, xpMax: 1999 },
  { titulo: 'Pythonista Senior', xpMin: 2000, xpMax: 3499 },
  { titulo: 'Arquitecto Python', xpMin: 3500, xpMax: 5999 },
  { titulo: 'Maestro Python', xpMin: 6000, xpMax: Infinity },
];
