...
export const leccion: Leccion = {
  ...
  ejercicios: [
    ...
    {
      id: 'no-06-02-02',
      titulo: 'Buscar con find()',
      descripcion: "Usa `print('Hola Mundo'.find('Mundo'))` para encontrar la posición de 'Mundo'.",
      starter: '# Busca con find()\n',
      pistas: ["print('Hola Mundo'.find('Mundo'))"],
      explicacion: "find() devuelve el índice donde empieza la subcadena, o -1 si no existe.",
      solucionOficial: "print('Hola Mundo'.find('Mundo'))",
