...
export const leccion: Leccion = {
  ...
  contenido: [
    ...
    { tipo: 'tabla-visual', titulo: 'Métodos de validación', cabeceras: ['Método', 'Descripción', '"Python"', '"123"', '"abc123"'], filas: [['isalpha()', 'Solo letras', 'True', 'False', 'False'], ['isdigit()', 'Solo dígitos', 'False', 'True', 'False'], ['isalnum()', 'Letras o dígitos', 'True', 'True', 'True'], ['isspace()', 'Solo espacios', 'False', 'False', 'False']] },
