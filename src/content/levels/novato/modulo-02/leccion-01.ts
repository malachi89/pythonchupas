...
export const leccion: Leccion = {
  ...
  contenido: [
    ...
    { tipo: 'tabla-visual', titulo: 'Variantes de range()', cabeceras: ['Llamada', 'Genera'], filas: [['range(5)', '0, 1, 2, 3, 4'], ['range(1, 6)', '1, 2, 3, 4, 5'], ['range(0, 10, 2)', '0, 2, 4, 6, 8'], ['range(5, 0, -1)', '5, 4, 3, 2, 1']] },
