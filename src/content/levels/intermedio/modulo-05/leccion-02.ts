...
export const leccion: Leccion = {
  ...
  contenido: [
    ...
    { tipo: 'tabla-visual', titulo: 'Operaciones con sets', cabeceras: ['Operación', 'Símbolo', 'Descripción'], filras: [['Unión', 'A | B', 'Elementos de A o B'], ['Intersección', 'A & B', 'Elementos en A y B'], ['Diferencia', 'A - B', 'Elementos en A pero no en B'], ['Dif. simétrica', 'A ^ B', 'Elementos en A o B, pero no en ambos']] },
