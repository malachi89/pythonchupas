...
export const leccion: Leccion = {
  ...
  contenido: [
    ...
    { tipo: 'tabla-visual', titulo: 'Tipos de datos básicos', cabeceras: ['Tipo', 'Descripción', 'Ejemplo'], filras: [['int', 'Números enteros', '42, -7, 0'], ['float', 'Números decimales', '3.14, -0.5'], ['str', 'Cadenas de texto', "'Hola', \"Adiós\""], ['bool', 'Booleanos', 'True, False']] },
